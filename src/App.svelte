...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="assets/IoThingsWareIcons/Cloud.png" />
    <link rel="icon" type="image/png" href="assets/IoThingsWareIcons/favicon.png" sizes="32x32" />
    <link rel="shortcut icon" href="assets/IoThingsWareIcons/favicon.png" />
